    ...
    <div class="row m-0">
        <div class="col-lg-4 offset-lg-2">
            <div class="text-center pb-5">    
                ...
                <p p-1 m-0 font-ubuntu text-black-50>Register and enjoy additional features</p>
            ...
            <div class="upload-profile-image d-flex justify-content-center pb-5">
                <div class="text-center">
                    ...
                    <img src="./assets/profile/beard.png" style="width:200px;height:200px" alt="profile" class="img-rounded-circle">
